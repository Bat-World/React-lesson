...
export default function Moods() {
  ...
  return (
    <div className="widget-moods container">
      ...
      <div>
        {}
        <button style={{ cursor: "pointer" }} onClick={() => setMood(happyMood)}>
          Make Happy
        </button>
        <button style={{ cursor: "pointer" }} onClick={() => setMood(sadMood)}>
          Make Sad
        </button>
        <button style={{ cursor: "pointer" }} onClick={() => setMood(initialMood)}>
          Reset
        </button>
      </div>
    </div>
